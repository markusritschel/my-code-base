...
.. py:function:: align_curves(ax1, y1, ax2, y2)
   ...
   :param ax1: The first of two axis to be aligned
   :type ax1: matplotlib.Axes.axis
   :param y1: The line on the first axis which will be used for alignment
   :type y1: np.ndarray
   :param ax2: The second of two axis to be aligned
   :type ax2: matplotlib.Axes.axis
   :param y2: The line on the second axis which will be used for alignment
   :type y2: np.ndarray
