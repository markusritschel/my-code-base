...
## Create a conda environment named 'my-code-base', install packages, and activate it
conda-env:
	@echo "Create conda environment 'my-code-base"
	conda create --name my-code-base python=3.10 --no-default-packages 
	@echo "Activate conda environment 'my-code-base'"
	conda activate my-code-base
