...
## Create a conda environment named 'my_code_base', install packages, and activate it
conda-env:
	@echo "Create conda environment 'my_code_base"
	conda create --name my_code_base python=3.10 --no-default-packages 
	@echo "Activate conda environment 'my_code_base'"
	conda activate my_code_base
